...
Date: 4/6/2022
Purpose of program:
Program compares different dates using various operators to determine
their relations to each other, as well as the number of hours between
2 given dates.
*/
...
int getMonth(string d)
{
   return stoi(d.substr(0,2)); // getting month wrong, only detects january and only sometimes
}
